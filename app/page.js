...
export default function Home() {
  ...
  return (
    <>
      ...
      <main className="flex flex-col gap-[32px] items-center text-center w-full px-10 2xl:px-20">
        <h1 className="text-[2rem] sm:text-[3rem] lg:text-[4rem] text-mg-navy font-bold mt-16 lg:mt-32">Hi! I'm Megan Godfrey.</h1>
        ...
        <div className="grid lg:grid-cols-2 xl:grid-cols-3 gap-x-10 2xl:gap-x-20 gap-y-8 my-16 w-full">
